...
export default function LoginForm({ onClose, onLoginSuccess, isPage = false }: LoginFormProps) {
  const { login } = useAuth();
  ...
  const formContent = (
    <div className={isPage ? "" : "rounded-3xl bg-white px-6 py-8 shadow-2xl ring-1 ring-sky-100 sm:px-10"}>
      {!isPage && (
